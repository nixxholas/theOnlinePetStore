...
namespace WEBA_ASSIGNMENT.Models
{
    public static class DataSeeder
    {
        public static async void SeedData(this IApplicationBuilder app)
        {
            ...
            //Declaring the User objects and assign it to null.
            //Need to assign null first so that the annoying using unassigned variable
            //error is not surfaced by Visual Studio.
            ShopUser georgeUser = null, amyUser = null, johnUser = null,
                 rachelUser = null, simonUser = null, steveUser = null;
            ShopUser larryUser = null, davidUser = null, cindyUser = null,
                 richardUser, desmondUser = null;


            amyUser = new ShopUser()
            {
                FullName = "AMY",
                IdentityCode = "0208881",
            ...
            db.ShopUsers.Add(amyUser);
            johnUser = new ShopUser()
            {
                FullName = "JOHN",
                IdentityCode = "0208882",
            ...
            db.ShopUsers.Add(johnUser);
            rachelUser = new ShopUser()
            {
                FullName = "RACHEL",
                IdentityCode = "0208883",
            ...
            db.ShopUsers.Add(rachelUser);
            simonUser = new ShopUser()
            {
                FullName = "SIMON",
                IdentityCode = "0208884",
            ...
            db.ShopUsers.Add(simonUser);
            steveUser = new ShopUser()
            {
                FullName = "STEVE",
                IdentityCode = "0208885",
            ...
            db.ShopUsers.Add(steveUser);
            larryUser = new ShopUser()
            {
                FullName = "LARRY",
                IdentityCode = "0208886",
            ...
            db.ShopUsers.Add(larryUser);
            davidUser = new ShopUser()
            {
                FullName = "DAVID",
                IdentityCode = "0208887",
            ...
            db.ShopUsers.Add(davidUser);
            cindyUser = new ShopUser()
            {
                FullName = "CINDY",
                IdentityCode = "0208888",
            ...
            db.ShopUsers.Add(cindyUser);
            richardUser = new ShopUser()
            {
                FullName = "RICHARD",
                IdentityCode = "0208889",
            ...
            db.ShopUsers.Add(richardUser);
            desmondUser = new ShopUser()
            {
                FullName = "DESMOND",
                IdentityCode = "0208890",
            ...
            db.ShopUsers.Add(desmondUser);
            georgeUser = new ShopUser()
            {
                FullName = "GEORGE",
                IdentityCode = "0208891",
